...
export function HomeHero({ home }: Props) {
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--color-surface)]">
      {/* HAVEN: dust motes drifting through the hero light */}
      <ParticleField className="pointer-events-none absolute inset-0" />
      <Container className="relative grid gap-12 py-20 md:grid-cols-[1.1fr_0.9fr] md:items-center md:gap-16 md:py-28">
        <div>
          {home.heroEyebrow ? (
